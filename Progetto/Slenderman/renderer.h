...
public:
    ...
    void renderAABB(const unsigned int& aabbVAO, Shader& shader, const glm::vec4& color);
...
void Renderer::renderAABB(const unsigned int& aabbVAO, Shader& shader, const glm::vec4& color = AABB_COLOR) {
    glBindFramebuffer(GL_FRAMEBUFFER, 0);
    glEnable(GL_DEPTH_TEST);
